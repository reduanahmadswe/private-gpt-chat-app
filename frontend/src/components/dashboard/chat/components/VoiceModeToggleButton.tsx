...
const VoiceModeToggleButton: React.FC<VoiceModeToggleButtonProps> = ({
  ...
  return (
    <button
      onClick={onClick}
      disabled={loading}
      className={`relative group px-3 lg:px-4 py-3 lg:py-4 rounded-xl lg:rounded-2xl transition-all duration-300 flex items-center justify-center min-w-[50px] lg:min-w-[60px] overflow-hidden ${
        loading
