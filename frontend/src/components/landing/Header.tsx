        ...
        <div className="flex items-center justify-between h-16 sm:h-20">
          ...
          <nav className="hidden md:flex items-center space-x-1 lg:space-x-2">
            <a
              ...
              className="text-[#E0E0E0] hover:text-white hover:bg-white/10 px-3 lg:px-4 py-2 rounded-xl transition-all duration-300 font-medium text-sm lg:text-base cursor-pointer whitespace-nowrap"
            >
              Features
            </a>
            <a
          ...
          <div className="hidden md:flex items-center space-x-3 lg:space-x-4 flex-shrink-0">
            <Link
              to="/auth/signin"
              className="text-[#E0E0E0] hover:text-white hover:bg-white/10 px-4 lg:px-5 py-2 lg:py-2.5 rounded-xl transition-all duration-300 font-medium text-sm lg:text-base whitespace-nowrap"
            >
              Sign In
            </Link>
            <Link
              to="/auth/signup"
              className="bg-gradient-to-r from-[#00f5ff] to-[#9d4edd] hover:from-[#9d4edd] hover:to-[#00f5ff] text-white px-4 lg:px-6 py-2 lg:py-2.5 rounded-xl transition-all duration-300 shadow-lg shadow-[#00f5ff]/25 hover:shadow-xl hover:shadow-[#9d4edd]/30 transform hover:scale-105 font-semibold text-sm lg:text-base whitespace-nowrap"
            >
              Get Started
            </Link>
          </div>
