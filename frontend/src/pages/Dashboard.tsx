...
const Dashboard: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#030637] flex overflow-hidden font-sans relative">
      ...
      <div
        className={`fixed right-0 top-0 h-full w-80 lg:w-96 bg-gradient-to-b from-[#030637] to-[#2a1a3e] backdrop-blur-xl border-l border-white/10 z-30 shadow-2xl shadow-black/20 transform transition-transform duration-300 ${
